...
class _OtpVerificationScreenState extends State<OtpVerificationScreen> {
  ...
  void _submitCode() async {
    ...
    if (code == widget.trueOtp) {
      ...
      // Correct OTP! Save the user to Firebase
      try {
        await DatabaseService.instance.insertUser(widget.userDetails).timeout(const Duration(seconds: 5));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        // Solid background replacement until the image issue is resolved
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(30), // Circular inputs
                            borderSide: const BorderSide(color: Color(0xFFC76CD9), width: 2), // Purple border
                          ),
